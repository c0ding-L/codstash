...
- Collection card background color derived from most-used content type in that collection. Read @context/features/item-type-card-color-handler.md  for how to handle cards background colors
